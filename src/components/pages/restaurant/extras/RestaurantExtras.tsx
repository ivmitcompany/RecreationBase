...
interface RestaurantExtrasProps extends HTMLAttributes<HTMLDivElement> {}
...
const extras = [
  ...
  {
    description:
      'Відпочиньте в нашому чудовому басейні з прекрасним краєвидом.',
    icon: (
      <svg
        className="h-6 w-6"
        fill="none"
...
const RestaurantExtras: FC<RestaurantExtrasProps> = ({
  className,
  ...props
}) => {
  return (
      ...
      <Content>
        <div className="mb-16 text-center">
          ...
          <p className="mx-auto max-w-2xl text-lg text-neutral-600">
            Ми пропонуємо не лише вишукану кухню, але й додаткові послуги для
            вашого повного комфорту та задоволення.
          </p>
        </div>
