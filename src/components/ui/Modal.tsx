...
const modalBodyVariants = cva('relative bg-light text-dark', {
  ...
  variants: {
    size: {
      card: 'w-full max-h-[35.9375rem] h-full md:max-h-[36.875rem] md:max-w-[36.875rem] overflow-y-auto',
      default:
        'w-full h-full md:max-h-[43.75rem] md:max-w-[68.75rem] px-5 py-20 md:py-[3.75rem] md:px-[3.25rem] overflow-y-auto md:overflow-hidden',
      screen:
